# Project Name : Fashion Hub HomePage ![Tech Stack Used](https://img.shields.io/badge/Technologies-HTML%20%26%20CSS-orange)
...
- In this project, I have built a **Fashion Hub HomePage** from the scratch using core `HTML` & `CSS`
...
> I took around **3 hours** to complete this project. The only thing that has taken much time to be implemented is how to adjust the **Model image and the squares image using z-index and absolute postion property in CSS.**
---
...
> [![Live Link](https://img.shields.io/badge/DEPLOYED-LINK-green)](https://fashion-hub-homepage.vercel.app/)
